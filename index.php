...
<html lang="en">
	...
	<body>
		...
		<h3>Attitudes</h3>
		<p>Aaron is choosy about his news resources and is often skeptical about the validity of articles posted by large
			media companies.</p>
		<h3>Goals</h3>
		...
		<div class="section userStory">
			<h2>User Story</h2>
			<p><q>As a consistent but unregistered user I want to determine who wrote a specific article quickly and
					easily.</q></p>
		</div>
		<div class="section useCaseInteraction">
			<h2>Scenario</h2>
			<p>While reading his usual sources for tech news Aaron reads through an article conveying opinions he tends to
				agree with.<br>
			...
			<ul>
				...
				<li>Site displays a banner image and information about the story including the article's publish date and
					author name.
				</li>
